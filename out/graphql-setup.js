...
GraphQLComponent = __decorate([
    lit_html_1.Component({
      ...
      <r-part>
        <r-state
          .value=${this.init.pipe(operators_2.switchMap(() => rxjs_1.from(Promise.resolve().then(() => __importStar(require("@rhtml/graphql/settings")))).pipe(operators_2.map(m => m.setConfig({
                config: {
                    uri: this.uri,
                    pubsub: this.pubsub,
            ...
            })), operators_2.switchMap(() => Promise.resolve().then(() => __importStar(require("@rhtml/graphql/index")))), operators_2.tap(() => this.remove()), operators_1.catchError(e => {
                return rxjs_1.of(e);
            }))))}
        >
        </r-state>
...
//# sourceMappingURL=graphql-setup.js.map